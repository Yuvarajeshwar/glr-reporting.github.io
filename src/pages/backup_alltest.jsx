...
export default function AllTestView() {
  ...
  const columns = [
    ...
    { field: "test_name", header: "Test Name", type: "text", sortable: false, department: "mailCommunication" },
    {
      field: "study_title",
      header: "Study Title",
      type: "text",
    ...
    },
    {
      ...
      {
        field: "study_director_name",
        header: "Study Director Name",
        type: "text",
        sortable: false,
        department: "edp"
      },
      ...
      {
        field: "study_plan_sponsor_approval_comments_received",
      ...
      {
        field: "study_plan_sponsor_approval_comments_sent_to_sd",
      ...
      {
        field: "corrected_draft_study_plan_to_yaminy",
      ...
      {
        field: "draft_report_sponsor_comments_to_sd",
      ...
      {
        field: "corrected_draft_report_to_yaminy",
      ...
      {
        field: "corrected_draft_report_sponsor_approval_received",
      ...
      {
        field: "definitive_report",
        header: "Definitive Report Taken (Date)",
        type: "date",
        sortable: false,
        department: "edp"
      },
      {
        field: "definitive_report_sent_to_qa",
        header: "Definitive Report Sent to QA (Date)",
        type: "date",
        sortable: false,
        department: "edp"
      },
      {
        field: "definitive_report_to_yaminy_by_qa",
        header: "Definitive Report Sent to Yaminy (Date)",
        type: "date",
        sortable: false,
        department: "qa"
      },
      {
        field: "definitive_report_to_sponsor",
        header: "Definitive Report Sent to Sponsor (Date)",
        type: "date",
        sortable: false,
        department: "mailCommunication"
      },
      {
        field: "definitive_report_sponsor_approval",
        header: "Definitive Report Sponsor Approval Received (Date)",
        type: "date",
        sortable: false,
        department: "mailCommunication"
      },
      {
        field: "definitive_report_comments_sent_to_sd",
        header: "Definitive Report Comments Sent to SD (Date)",
        type: "date",
        sortable: false,
        department: "mailCommunication"
      },
      ...
      {
        field: "internal_memo_no",
        header: "Internal Memo No",
        type: "text",
        sortable: false,
        department: "mailCommunication"
      },
      {
        field: "assigned_to_qc_head",
        header: "Assigned to QC Head (Date)",
        type: "date",
        sortable: false,
        department: "edp"
      },
      {
        field: "assigned_to_qc_staff",
        header: "Assigned to QC Staff (Date)",
        type: "date",
        sortable: false,
        department: "edp"
      },
      {
        field: "qc_comments_to_qc_head",
        header: "QC Comments Sent to QC Head (Date)",
        type: "date",
        sortable: false,
        department: "mailCommunication"
      },
      {
        field: "qc_comments_to_yaminy",
        header: "QC Comments Sent to Yaminy (Date)",
        type: "date",
        sortable: false,
        department: "mailCommunication"
      },
      {
        field: "qc_comments_to_sd",
        header: "QC Comments Sent to SD (Date)",
        type: "date",
        sortable: false,
        department: "mailCommunication"
      }
